...
class EmbeddingRetriever:
    ...
    def search_by_query(self, query_text, top_k=5):
        ...
        semantic = SemanticHotelRetriever(self.driver)
        
        # Share FAISS index
        semantic.faiss_index = self.faiss_index
        semantic.hotel_id_to_idx = self.hotel_id_to_idx
        semantic.idx_to_hotel_id = self.idx_to_hotel_id
        
        # Process query
        return semantic.search_by_query(query_text, top_k)
