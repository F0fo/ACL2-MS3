...
\begin{itemize}
    \setlength{\itemsep}{0.2em}
    \item \textbf{Robotic responses:} LLM started with ``Based on the data...''
    \begin{itemize}
        \item Fixed via persona prompt engineering
    \end{itemize}
    \item \textbf{Hallucinations:} Invented hotel names not in KG
    \begin{itemize}
        \item Fixed by injecting actual KG context
    \end{itemize}
    \item \textbf{API timeouts:} HuggingFace rate limits
    \begin{itemize}
        \item Added retry logic and error handling
    \end{itemize}
\end{itemize}
\end{column}
